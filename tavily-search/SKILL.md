---
name: tavily-search
description: Tavily网络搜索：LLM优化的网页搜索 - Search the web with LLM-optimized results via the Tavily CLI. Use when: searching the web, finding articles, looking up information, getting recent news.
