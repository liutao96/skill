---
name: github-to-skills 仓库转技能
description: 将 GitHub 仓库自动转换为专业 AI 技能的工厂工具。当用户提供 GitHub URL 并希望"打包"、"封装"或"创建技能"时使用此技能。它自动获取仓库详情、最新提交哈希，并生成带有增强元数据的标准化技能结构，便于生命周期管理。
license: MIT
---
